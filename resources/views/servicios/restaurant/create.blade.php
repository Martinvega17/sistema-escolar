...
@section ('contenido')
	<div class="row">
		<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
			<h3>Nuevo Producto de restaurante</h3>

			<form action="{{ route('restaurant.store', '$restaurant') }}"  method="POST" >
				@method('post')
				@csrf	
				...
				<div class="form-group">
    				...
    				<input type="text" name="vendido" class="form-control" placeholder="Vendidos...">
				</div>
				<div class="form-group">
